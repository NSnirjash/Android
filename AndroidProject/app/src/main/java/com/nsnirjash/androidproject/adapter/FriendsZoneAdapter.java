...
public class FriendsZoneAdapter extends RecyclerView.Adapter<FriendsZoneAdapter.viewHolder>{

    private List<FriendsZoneModel> friendsZoneModelList;
    private Context context;

    public FriendsZoneAdapter(List<FriendsZoneModel> friendsZoneModelList, Context context) {
        this.friendsZoneModelList = friendsZoneModelList;
    ...
    @NonNull
    @Override
    public FriendsZoneAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.member_details, parent, false);

        return new FriendsZoneAdapter.viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FriendsZoneAdapter.viewHolder holder, int position) {

        FriendsZoneModel member = friendsZoneModelList.get(position);
        holder.bind(member);
    ...
    public int getItemCount() {
        return friendsZoneModelList.size();
    }
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(FriendsZoneModel member) {
