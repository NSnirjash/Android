...
public class PurbachalModelAdapter extends RecyclerView.Adapter<PurbachalModelAdapter.viewHolder>{
    ...
    @NonNull
    @Override
    public PurbachalModelAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PurbachalModelAdapter.viewHolder holder, int position) {
