...
public class JatrabariClubAdapter extends RecyclerView.Adapter<JatrabariClubAdapter.viewHolder>{

    private List<JatrabariClubModel> jatrabariClubModelList;
    private Context context;

    public JatrabariClubAdapter(List<JatrabariClubModel> jatrabariClubModelList, Context context) {
        this.jatrabariClubModelList = jatrabariClubModelList;
    ...
    @NonNull
    @Override
    public JatrabariClubAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.member_details, parent, false);

        return new JatrabariClubAdapter.viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull JatrabariClubAdapter.viewHolder holder, int position) {

        JatrabariClubModel member = jatrabariClubModelList.get(position);
        holder.bind(member);
    ...
    public int getItemCount() {
        return jatrabariClubModelList.size();
    }
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(JatrabariClubModel member) {
