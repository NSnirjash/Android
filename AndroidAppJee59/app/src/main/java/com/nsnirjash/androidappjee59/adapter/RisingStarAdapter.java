...
import com.nsnirjash.androidappjee59.model.RisingStarModel;
...
public class RisingStarAdapter extends RecyclerView.Adapter<RisingStarAdapter.viewHolder>{
    ...
    private List<RisingStarModel> RisingStarModelList;
    private Context context;

    public RisingStarAdapter(List<RisingStarModel> risingStarModelList, Context context) {
        RisingStarModelList = risingStarModelList;
    ...
    @NonNull
    @Override
    public RisingStarAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.member_details, parent, false);

        return new RisingStarAdapter.viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RisingStarAdapter.viewHolder holder, int position) {

        RisingStarModel member = RisingStarModelList.get(position);
        holder.bind(member);
    ...
    public int getItemCount() {
        return RisingStarModelList.size();
    }
    ...
    public static class viewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(RisingStarModel member) {
